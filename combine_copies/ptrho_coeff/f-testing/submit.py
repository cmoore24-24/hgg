...
def main():
    ...
    homedir = '/users/cmoore24/Public/combine/test_rhalphalib/CMSSW_14_1_0_pre4/src/HiggsAnalysis/rhalphalib/run_scripts/ptrho_coeff/f-testing/'+year+'/comparisons/'
    outdir = homedir + tag 
