...
qcd = ak.from_parquet('/scratch365/cmoore24/training/hgg/batch2025/inputs/qcd_sculpted_ratios.parquet', columns='train_ratios').train_ratios
...
test_loader = DataLoader(test_dataset, batch_size=batchsize, shuffle=False, num_workers=6)

# Neural Network definition
class NeuralNetwork(nn.Module):
    def __init__(self, input_size, width, num_layers, dropout_rate=0.1):
