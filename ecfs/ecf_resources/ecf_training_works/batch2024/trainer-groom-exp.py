...
output_dir = f"./outputs_grm/stitched_qcd/sculpted_qcd/ungrm_{num_nodes}nodes_{layers}layers_{batchsize}batch"
...
qcd = pd.read_parquet('/scratch365/cmoore24/training/hgg/batch/inputs/grm_ungrm/sculpted_stitched_qcd_all_ratios.parquet')
#qcd = pd.read_parquet('/scratch365/cmoore24/training/hgg/batch/inputs/grm_ungrm/flat_qcd_all_ratios.parquet')
